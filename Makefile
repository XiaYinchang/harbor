...
GOBASEPATH=/go/src/github.com/XiaYinchang
CHECKENVCMD=checkenv.sh

# parameters
REGISTRYSERVER=
REGISTRYPROJECTNAME=xyc11223344
DEVFLAG=true
NOTARYFLAG=false
CLAIRFLAG=false
HTTPPROXY=
...
# docker image name
DOCKERIMAGENAME_ADMINSERVER=xyc11223344/harbor-adminserver
DOCKERIMAGENAME_PORTAL=xyc11223344/harbor-portal
DOCKERIMAGENAME_CORE=xyc11223344/harbor-core
DOCKERIMAGENAME_JOBSERVICE=xyc11223344/harbor-jobservice
DOCKERIMAGENAME_LOG=xyc112223344/harbor-log
DOCKERIMAGENAME_DB=xyc11223344/harbor-db
DOCKERIMAGENAME_CHART_SERVER=xyc11223344/chartmuseum-photon
DOCKERIMAGENAME_REGCTL=xyc11223344/harbor-registryctl
