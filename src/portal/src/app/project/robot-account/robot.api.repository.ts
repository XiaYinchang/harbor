...
export class RobotApiRepository {
  ...
  public postRobot(projectId, param): Observable<any> {
    return this.http
      .post(`/uai-harbor/api/projects/${projectId}/robots`, param)
  ...
  public deleteRobot(projectId, id): Observable<any> {
    return this.http
      .delete(`/uai-harbor/api/projects/${projectId}/robots/${id}`)
      .pipe(catchError(error => observableThrowError(error)));
  }

  public listRobot(projectId): Observable<Robot[]> {
    return this.http
      .get(`/uai-harbor/api/projects/${projectId}/robots`)
  ...
  public getRobot(projectId, id): Observable<Robot[]> {
    return this.http
      .get(`/uai-harbor/api/projects/${projectId}/robots/${id}`)
      .pipe(map(response => response.json() as Robot[]))
      .pipe(catchError(error => observableThrowError(error)));
  }
  ...
  public toggleDisabledAccount(projectId, id, data): Observable<any> {
    return this.http
      .put(`/uai-harbor/api/projects/${projectId}/robots/${id}`, data)
      .pipe(catchError(error => observableThrowError(error)));
  }
}
